// ConversionBannerReseau.tsx — Fidèle à Emergent UniversalBanner variant="reseau"

import { Link } from 'react-router-dom'
import { motion } from 'framer-motion'

export default function ConversionBannerReseau() {
  return (
    <motion.div
          ...
          <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 pl-2">
            <div className="flex-1 min-w-0">
              <h3 className="font-bold text-lg lg:text-xl leading-tight mb-1" style={{ color: '#0F172A' }}>
                Rejoins la communauté du bâtiment
              </h3>
              <p className="text-sm lg:text-base leading-relaxed mb-1" style={{ color: '#374151' }}>
                Partage tes chantiers, trouve des opportunités, développe ton réseau
              </p>
              <p className="text-xs text-gray-500 mt-1">
                ✓ 1 compte certifié · ✓ Réseau 100% vérifié
              </p>
            </div>
