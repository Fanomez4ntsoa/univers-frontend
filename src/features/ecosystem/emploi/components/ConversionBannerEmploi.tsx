// ConversionBannerEmploi.tsx — Fidèle à Emergent UniversalBanner variant="emploi"

import { Link } from 'react-router-dom'
import { motion } from 'framer-motion'

export default function ConversionBannerEmploi() {
  return (
    <motion.div
          ...
          <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 pl-2">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm lg:text-base leading-relaxed mb-1" style={{ color: '#374151' }}>
                Trouve les bons profils dans le BTP — gratuit pendant la Beta
              </p>
              <p className="text-xs text-gray-500 mt-1">
                ✓ Offres illimitées · ✓ Candidats qualifiés BTP
              </p>
            </div>
