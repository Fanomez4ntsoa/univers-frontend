// ConversionBanner.tsx — Fidèle à Emergent UniversalBanner.jsx variant="artisans"
// Bandeau bleu #EEF2FF + border-left orange #E8650A — mobile only
        ...
        >
          <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 pl-2">
            <div className="flex-1 min-w-0">
              <h3
                className="font-bold text-lg lg:text-xl leading-tight mb-1"
                style={{ color: '#0F172A' }}
              >
                Rejoins les artisans certifiés
              </h3>
              <p
                className="text-sm lg:text-base leading-relaxed mb-1"
                style={{ color: '#374151' }}
              >
                Crée ton profil pro — sois visible dès le lancement
              </p>
              <p className="text-xs text-gray-500 mt-1">
                ✓ Gratuit pendant la Beta · ✓ 1 an offert aux membres fondateurs
              </p>
            </div>
            ...
            <Link to="/register" className="flex-shrink-0 w-full sm:w-auto">
              <motion.button
                ...
                style={{
                  ...
                  boxShadow: '0 4px 12px rgba(26,42,74,0.25)',
                }}
              >
